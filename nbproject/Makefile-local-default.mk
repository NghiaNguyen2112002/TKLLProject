...
#
SHELL=cmd.exe
PATH_TO_IDE_BIN=F:/PIC IDE/mplab_platform/platform/../mplab_ide/modules/../../bin/
# Adding MPLAB X bin directory to path.
PATH:=F:/PIC IDE/mplab_platform/platform/../mplab_ide/modules/../../bin/:$(PATH)
# Path to java used to run MPLAB X when this makefile was created
MP_JAVA_PATH="F:\PIC IDE\sys\java\zulu8.54.0.21-ca-fx-jre8.0.292-win_x64/bin/"
...
DEP_GEN=${MP_JAVA_PATH}java -jar "F:/PIC IDE/mplab_platform/platform/../mplab_ide/modules/../../bin/extractobjectdependencies.jar"
...
# MP_BC_DIR is not defined
DFP_DIR=F:/PIC IDE/packs/Microchip/PIC18Fxxxx_DFP/1.3.36
